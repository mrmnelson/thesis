...
\newacronym{CCDC}{CCDC}{Cambridge Crystallographic Data Centre}
\newacronym{TON}{TON}{turnover number}
\newacronym{dppp}{dppp}{1,2-(diphenylphosphino)propane}
\newacronym{dbpx}{dbpx}{$\alpha$,$\alpha$\textprime-bis(di-t-butylphosphino)-\emph{o}-xylene}
\newacronym{BINAP}{BINAP}{2,2\textprime-bis(diphenylphosphino)-1,1\textprime-binaphthyl}
\newacronym{BISBI}{BISBI}{1,1\textprime-bis(diphenylphosphinomethyl)-2,2\textprime-biphenyl}
\newacronym{dppf}{dppf}{1,1\textprime-Bis(diphenylphosphino)ferrocene}
\newacronym{NMR}{NMR}{nuclear magnetic resonance}
\newacronym{dppb}{dppb}{1,2-(diphenylphosphino)butane}
\newacronym{depp}{depp}{1,2-(diethylphosphino)propane}
