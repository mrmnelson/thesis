...
The three \tBuxantphos{} ligands were synthesised using an adaptation of the method used for the \Phxantphos{} analogues.  The natural bite-angles of the \Phxantphos{} and \tBuxantphos{} ligands were calculated using DFT with the values for the \Phxantphos{} ligands consistent with those from molecular mechanics.  The bite-angle of the \tBuxantphos{} ligands is larger due to the increased steric bulk of the \tBu{} substituents.  The electronic properties of the \tBuxantphos{} ligands were investigated by synthesis of the phosphine selenides.  The value of \JPSe{} varied between \fixme{values} indicating a basicity between \ce{PPh2Me} and \ce{PMe3}, higher than \Phxantphos{}.  

Two types of silver complexes, [Ag(\tBuxantphos)Cl] and [Ag(\tBuxantphos)]\ce{BF4} were synthesised with the \tBuxantphos{} ligands.  All species were monomeric indicating the protection of the silver centre by the \tBuxantphos{} ligands.  [Rh(\tBuxantphos)Cl] complexes were synthesised which reacted with hydrogen, forming [Rh(\tBuxantphosk)Cl(\ce{H)2}] and carbon monoxide, forming [Rh(\tBuxantphos)(CO\ce{)2Cl]}.  The [Rh(\tBuxantphos)Cl] are air-sensitive producing [Rh(\tBuxantphos)Cl(\hapto{2}-\ce{O2}], the X-ray crystal structure of which, contained 15\% of the dioxygen sites replaced with an oxo ligand.  This is the first crystallographic evidence of a rhodium(III) oxo complex, and only the third rhodium oxo species reported.  

The coordination chemistry of the ligands with platinum(0) and palladium(0) showed some differences.  [Pt(\tBuxantphos)(\ce{C2H4})] complexes were synthesised for all three ligands.  However, reaction with [Pt(nb\ce{)3}] produced a mixture of [Pt(\tBuxantphos)] and [Pt(\tBuxantphos)(nb)] for \tBusixantphos{} and \tButhixantphos{}.  Although few examples of isolatable [Pt(PP)] complexes with diphosphines have been reported [Pt(\tButhixantphos)] was isolated by removable of the norbornene.  The \tBusixantphos{} reaction went on to produce an unidentified Pt(II) species.  Using \tBuxantphos{} formed small amounts of [Pt(\tBuxantphos)] initially, which to give a progressed to a [Pt(\tBuxantphos)H]X complex.  The analogous reactions with [Pd(nb\ce{)3}] gave [Pd(\tBuxantphos)] complexes in all cases.  [Pt(\tButhixantphos)(\ce{C2H4})], [M(\tButhixantphos)] (M = Pd, Pt) react with oxygen forming [Pt(\tButhixantphos)(\hapto{2}-\ce{O2})].  This dioxygen complex was unreactive towards \fixme{examples} but, reacted with CO to give [Pt(\tButhixantphos{}-H-\dento{}-\emph{C,P,P}\textprime{})OH] through a series of intermediates.  

[M(\tBuxantphos)\ce{Cl2}] (M = Pd, Pt) were synthesised, showing exclusive \trans{} coordination of the diphosphine ligands.  The X-ray crystal structure of [Pt(\tButhixantphos)\ce{Cl2}] has a bite-angle of 151.722(15)\degrees{}.  This is the first [Pt\ce{Cl2}(PP)] complex with a bite-angle between 114 and 171\degrees{}, further indicating the ability of the \tBuxantphos{} ligands to support metals in unusual geometries.  In polar solvents a chloride ligand dissociates from the [Pt(\tBuxantphos)\ce{Cl2}] complexes producing [Pt(\tBuxantphosk)Cl\ce{]+}.  The analogous [Pd(\tBuxantphosk)Cl\ce{]+} was formed by reaction of the dichloride with \ce{NH4PF6}.  The [Pt(\tBuxantphosk)Me\ce{]+} pincer complexes were the only product from reaction with [Pt(\ce{C6H10)}ClMe], with the stronger \trans{} influence of the methyl ligand promoting loss of the chloride. 

The values of \JPtC{} for the methyl carbons in the [Pt(\tBuxantphosk)Me\ce{]+} complexes, and \JPtH{} for the hydride \trans{} to the oxygen atom in the [Rh(\tBuxantphosk)Cl(\ce{H)2}] complexes were largest for \tBusixantphos, then \tButhixantphos, then \tBuxantphos{}.  Hence the \trans{} influence of the \tBuxantphos{} oxygen donor follows the trend \tBuxantphos{} \textless{} \tButhixantphos{} \textless{} \tBusixantphos{}.}
