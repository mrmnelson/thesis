...
\caption[Reaction between \tBuxantphos{} and [Pt(nb\ce{)3}{]}]{Reaction between \tBuxantphos{} and [Pt(nb\ce{)3].}  \emph{Reagents and conditions:} (i) [Pt(nb\ce{)3}], \ce{C6D6}, 60\degC{}, 24 hours.}
\vspace{0.2cm}
...
\caption[X-ray crystal structure of \texorpdfstring{[Pt(\tButhixantphos)(\hapto{2}-\ce{O2}){]}} P $\cdot{}$ \ce{2C6D6}]{[Pt(\tButhixantphos)(\hapto{2}-\ce{O2})] $\cdot{}$ \ce{2C6D6}.  Hydrogen atoms and solvent molecules omitted for clarity.}
\vspace{0.2cm}
...
\caption[X-ray crystal structure of \texorpdfstring{[Pt(\tButhixantphos)(\hapto{2}-\ce{O2}){]}} P $\cdot{}$ \ce{2C6D6} side view]{[Pt(\tButhixantphos)(\hapto{2}-\ce{O2})] $\cdot{}$ \ce{2C6D6}, side view.  Hydrogen atoms and solvent molecules omitted for clarity.}
\vspace{0.2cm}
