...
\fixme{some of the aromatic bonds are slightly bolder than others}
\fixme{norbornene is overlapping with the bond to it}
\fixme{square brackets around norbornene}
...
\fixme{square brackets around Pt(nb)3}
...
\fixme{Teresa doesn't think a scheme is necessary}
...
\caption[Reaction between \tButhixantphos{} and tris(ethene)platinum]{Reaction between \tButhixantphos{} and tris(ethene)platinum.}
\vspace{0.2cm}
...
The [Pd(\hapto{2}-\ce{O2})(\ce{P^{t}Bu2Ph)2}] complex readily loses dioxygen under vacuum, although the dioxygen ligand in [Pt(\hapto{2}-\ce{O2})(\ce{P^{t}Bu2Ph)2}] does not dissociate under the same conditions.\cite{Yoshida1979}  Recent work in our group has shown that [Pt(\hapto{2}-\ce{O2})(\ce{P^{t}Bu2Bn)}] can also lose oxygen under vacuum.\fixme{cite Kathryn and Rosie}  The dioxygen ligand in the [Pt(\tButhixantphos)(\hapto{2}-\ce{O2})] complex was not observed to dissociate despite heating the reaction under vacuum.  This result is not unexpected as the \tButhixantphos{} system is more sterically and electronically similar to \ce{P^{t}Bu2Ph} than \ce{P^{t}Bu2Bn}.  However, the larger P-Pt-P angle in the \tButhixantphos{} complex (117.26(5)\degrees) compared to the \ce{P^{t}Bu2Ph} complex (113.1(2)\degrees) may been expected to promote the lose of the dioxygen ligand.\cite{Yoshida1979}  
...
\fixme{some bonds are slightly thicker}
\fixme{longer bonds to hydroxyl and the bicarbonate ligand}
...
Initial investigations focussed on the reaction of \tButhixantphos{} with palladium(0) precursors commonly used in catalysis.  Allyl-(cyclopentadienyl)palladium(II) ([Pd(\ce{C3H5})Cp]) can react with phosphine ligands to give palladium(0) complexes.\fixme{reference} The reaction between \tButhixantphos{} and [Pd(\ce{C3H5})Cp] in \ce{C6D6} was slow.  After 24 hours at room temperature no changes in the NMR spectra were observed.  After 48 hours at 50 \degC{} no unreacted \tButhixantphos{} was observed in the \phosphorus{} NMR spectrum.  However, the \phosphorus{} and \proton{} NMR spectra showed a number of different products, which were unable to be separated or analysed further.
...
\fixme{brackets around Pd(nb)3}
\fixme{change S to X in product}
\fixme{change Pt to Pd in product}
...
No evidence for a bis(diphosphine) complex was observed in the reactions of the \tBuxantphos{} ligands with platinum alkene and palladium tris(norbornene) starting materials.  Reaction with [Pd(nb\ce{)3}] formed [Pd(\tBuxantphos)] as the only product.  In contrast, reaction of \tButhixantphos{} with [Pt(nb\ce{)3}] formed a mixture of [Pt(\tButhixantphos)] and [Pt(\tButhixantphos)(nb)].  Analogues of these two complexes were also observed in the analogous reaction with \tBusixantphos{}, in addition to an unknown complex with a coupling constant indicative of platinum(II).  The reaction between [Pt(nb\ce{)3}] and \tBuxantphos{} formed [Pt(\tBuxantphos)] as a minor component which converted into [Pt(\tBuxantphos)H]X.  

Reaction of \tBusixantphos{}, \tButhixantphos{}, and \tBuxantphos{} with [Pt(\ce{C2H4)3}] resulted in [Pt(\tBuxantphos)\ce{(C2H4)3}] complexes.  [Pt(\tBuxantphos)\ce{(C2H4)3}] went on to produce [Pt(\tBuxantphos)H]X.  The reaction between \tButhixantphos{} and [Pt(cod\ce{)2}] formed only [Pt(\tButhixantphos)], though the yield was low due to degradation.  Evidence was present for the formation of 1,3- and 1,4-cyclooctadiene.  

[Pd(\tButhixantphos)], [Pt(\tButhixantphos)], and [Pt(\tButhixantphos)(\ce{C2H4)3}] all react rapidly with air forming [M(\tButhixantphos)(\hapto{2}-\ce{O2})] (M = Pd, Pt).  With palladium this reaction was readily reversibly in a few minutes under vacuum.  On platinum the coordination of oxygen was not reversible either by vacuum, or reaction with \ce{C2H4} or \ce{H2}.  [Pt(\tButhixantphos)(\hapto{2}-\ce{O2})] was characterised by X-ray crystallography, displacing a planar molecule with a bent \tButhixantphos{} backbone.  The bite-angle was 117.26(5), smaller than the natural bite-angle of \fixme{value from DFT}, but the largest P-Pt-P angle of the five [Pt(\hapto{2}-\ce{O2})(\ce{P2})] complexes that have been characterised crystallographically.  
